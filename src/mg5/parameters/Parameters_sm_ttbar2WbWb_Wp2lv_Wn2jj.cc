...
#include "hhAnalysis/bbwwMEM/interface/mg5/parameters/Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj.h"
#include "tthAnalysis/tthMEM/interface/Logger.h"

#include <iomanip> 

// Initialize static instance
Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj * Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj::instance = nullptr;

// Function to get static instance - only one instance per program
Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj * Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj::getInstance()
{
  if (! instance)
    instance = new Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj();

  return instance; 
}

void Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj::setIndependentCouplings()
{
  GC_100 = (mdl_ee * mdl_complexi * mdl_conjg__CKM1x1)/(mdl_sw * mdl_sqrt__2); 
}
void Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj::setDependentCouplings()
{
...
void Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj::printIndependentParameters()
{
  LOGVRB <<  "sm model parameters independent of event kinematics:" << endl;
...
void Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj::printIndependentCouplings()
{
  LOGVRB <<  "sm model couplings independent of event kinematics:" << endl;
  LOGVRB << setw(20) <<  "GC_100 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_100 << endl;
}
void Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj::printDependentParameters()
{
  LOGVRB <<  "sm model parameters dependent on event kinematics:" << endl;
...
void Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj::printDependentCouplings()
{
  LOGVRB <<  "sm model couplings dependent on event kinematics:" << endl;
