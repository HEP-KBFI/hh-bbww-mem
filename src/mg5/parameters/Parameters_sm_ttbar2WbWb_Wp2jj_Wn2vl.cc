...
Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl * Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl::instance = nullptr;

// Function to get static instance - only one instance per program
Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl * Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl::getInstance()
{
  if (! instance)
    instance = new Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl();

  return instance; 
}

void Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl::setIndependentCouplings()
{
  GC_100 = (mdl_ee * mdl_complexi * mdl_conjg__CKM1x1)/(mdl_sw * mdl_sqrt__2); 
}
void Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl::setDependentCouplings()
{
...
void Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl::printIndependentParameters()
{
...
void Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl::printIndependentCouplings()
{
  LOGVRB <<  "sm model couplings independent of event kinematics:" << endl;
  LOGVRB << setw(20) <<  "GC_100 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_100 << endl;
}
void Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl::printDependentParameters()
{
...
void Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl::printDependentCouplings()
{
