...
Parameters_BSM_gg_hh2bbWW_WW2lvlv * Parameters_BSM_gg_hh2bbWW_WW2lvlv::instance = nullptr;

// Function to get static instance - only one instance per program
Parameters_BSM_gg_hh2bbWW_WW2lvlv * Parameters_BSM_gg_hh2bbWW_WW2lvlv::getInstance()
{
  if (! instance)
    instance = new Parameters_BSM_gg_hh2bbWW_WW2lvlv();

  return instance;
}

void Parameters_BSM_gg_hh2bbWW_WW2lvlv::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0;
  ZERO = 0;
...
void Parameters_BSM_gg_hh2bbWW_WW2lvlv::setDependentParameters() // SLHAReader& slha, bool firstTime
{
...
void Parameters_BSM_gg_hh2bbWW_WW2lvlv::printIndependentParameters()
{
...
void Parameters_BSM_gg_hh2bbWW_WW2lvlv::printIndependentCouplings()
{
...
void Parameters_BSM_gg_hh2bbWW_WW2lvlv::printDependentParameters()
{
...
void Parameters_BSM_gg_hh2bbWW_WW2lvlv::printDependentCouplings()
{
