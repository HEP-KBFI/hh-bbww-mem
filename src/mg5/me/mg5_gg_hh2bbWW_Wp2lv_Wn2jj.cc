...
void mg5_BSM_gg_hh2bbWW_Wp2lv_Wn2jj::initProc(const string & param_card_name)
{
  param_card_name_ = param_card_name;
  // Instantiate the model class and set parameters that stay fixed during run
  pars = Parameters_BSM_gg_hh2bbWW_Wp2lv_Wn2jj::getInstance();
...
void mg5_BSM_gg_hh2bbWW_Wp2lv_Wn2jj::sigmaKin(bool & firsttime)
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_1_gg_hh_h_bbx_h_wpwm_wp_epve_wm_dux();
...
double mg5_BSM_gg_hh2bbWW_Wp2lv_Wn2jj::sigmaHat()
{
...
//--------------------------------------------------------------------------
// Set Higgs width
void mg5_BSM_gg_hh2bbWW_Wp2lv_Wn2jj::setHiggsWidth(double higgsWidth)
{
...
void mg5_BSM_gg_hh2bbWW_Wp2lv_Wn2jj::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double mg5_BSM_gg_hh2bbWW_Wp2lv_Wn2jj::matrix_1_gg_hh_h_bbx_h_wpwm_wp_epve_wm_dux()
{
  int i, j;
  // Local variables
  const int ncolor = 1;
