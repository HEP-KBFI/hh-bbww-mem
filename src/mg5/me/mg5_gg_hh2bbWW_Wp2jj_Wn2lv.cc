...
#include "hhAnalysis/bbwwMEM/interface/mg5/helamps/HelAmps_BSM_gg_hh2bbWW_Wp2jj_Wn2lv.h"

#include <iostream>

using namespace MG5_BSM_gg_hh2bbWW_Wp2jj_Wn2lv;
...
void mg5_BSM_gg_hh2bbWW_Wp2jj_Wn2lv::initProc(const string & param_card_name)
{
  param_card_name_ = param_card_name;
  // Instantiate the model class and set parameters that stay fixed during run
  pars = Parameters_BSM_gg_hh2bbWW_Wp2jj_Wn2lv::getInstance();
...
void mg5_BSM_gg_hh2bbWW_Wp2jj_Wn2lv::sigmaKin(bool & firsttime)
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_1_gg_hh_h_bbx_h_wpwm_wp_udx_wm_emvex();
...
double mg5_BSM_gg_hh2bbWW_Wp2jj_Wn2lv::sigmaHat()
{
...
//--------------------------------------------------------------------------
// Set Higgs width
void mg5_BSM_gg_hh2bbWW_Wp2jj_Wn2lv::setHiggsWidth(double higgsWidth)
{
...
void mg5_BSM_gg_hh2bbWW_Wp2jj_Wn2lv::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_3(w[6], w[5], pars->GC_13, pars->mdl_MW, pars->mdl_WW, w[7]);
...
double mg5_BSM_gg_hh2bbWW_Wp2jj_Wn2lv::matrix_1_gg_hh_h_bbx_h_wpwm_wp_udx_wm_emvex()
{
  int i, j;
  // Local variables
  const int ncolor = 1;
  ...
  static const double cf[ncolor][ncolor] = {{18}};
