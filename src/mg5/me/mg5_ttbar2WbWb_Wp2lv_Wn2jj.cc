...
#include "hhAnalysis/bbwwMEM/interface/mg5/helamps/HelAmps_sm_ttbar2WbWb_Wp2lv_Wn2jj.h"

using namespace MG5_sm_ttbar2WbWb_Wp2lv_Wn2jj;
...
void mg5_sm_ttbar2WbWb_Wp2lv_Wn2jj::initProc(const string & param_card_name)
{
  // Instantiate the model class and set parameters that stay fixed during run
  pars = Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj::getInstance();
...
void mg5_sm_ttbar2WbWb_Wp2lv_Wn2jj::sigmaKin()
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_1_gg_ttx_t_wpb_wp_epve_tx_wmbx_wm_dux(); 
...
double mg5_sm_ttbar2WbWb_Wp2lv_Wn2jj::sigmaHat()
{
...
void mg5_sm_ttbar2WbWb_Wp2lv_Wn2jj::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double mg5_sm_ttbar2WbWb_Wp2lv_Wn2jj::matrix_1_gg_ttx_t_wpb_wp_epve_tx_wmbx_wm_dux()
{
  int i, j; 
  // Local variables
  const int ncolor = 2; 
