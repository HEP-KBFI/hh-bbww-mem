...
class mg5_sm_ttbar2WbWb_WW2lvlv
{
  public:

    // Constructor.
    mg5_sm_ttbar2WbWb_WW2lvlv()
    {
    ...
    // Destructor.
    virtual ~mg5_sm_ttbar2WbWb_WW2lvlv()
    {
      for(std::size_t i = 0; i < nprocesses; ++i)
      {
        if(jamp2[i])
  ...
  private:
    ...
    Parameters_sm_ttbar2WbWb_WW2lvlv * pars;
...
#endif  // MG5_sm_ttbar2WbWb_WW2lvlv_H
