...
#ifndef Parameters_sm_ttbar2WbWb_WW2lvlv_H
#define Parameters_sm_ttbar2WbWb_WW2lvlv_H

#include "tthAnalysis/tthMEM/interface/mg5/read_slha.h"

#include <complex>

class Parameters_sm_ttbar2WbWb_WW2lvlv
{
  public:

    static Parameters_sm_ttbar2WbWb_WW2lvlv * getInstance();
  ...
  private:
    static Parameters_sm_ttbar2WbWb_WW2lvlv * instance;
}; 

#endif  // Parameters_sm_ttbar2WbWb_WW2lvlv_H
