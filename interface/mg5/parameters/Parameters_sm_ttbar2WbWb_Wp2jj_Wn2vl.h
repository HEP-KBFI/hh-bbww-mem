...
#ifndef Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl_H
#define Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl_H

#include "tthAnalysis/tthMEM/interface/mg5/read_slha.h"

#include <complex> 

class Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl
{
  public:

    static Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl * getInstance();
  ...
  private:
    static Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl * instance;
}; 

#endif  // Parameters_sm_ttbar2WbWb_Wp2jj_Wn2vl_H
