...
#ifndef Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj_H
#define Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj_H

#include "tthAnalysis/tthMEM/interface/mg5/read_slha.h"

#include <complex>

class Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj
{
  public:

    static Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj * getInstance();
  ...
  private:
    static Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj * instance;
}; 

#endif  // Parameters_sm_ttbar2WbWb_Wp2lv_Wn2jj_H
